...
<!-- Hero Section-->
<section style="background: url(../assets/img/hero.jpg); background-size: cover; background-position: center center" class="hero">
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
        <h1>The space to build a community for SAE students and alumni.</h1><a href="../account/register.php" class="hero-link button">Join Today</a>
      </div>
...
<section class="featured-posts no-padding-top">
  <div class="container">
    ...
    <div class="row d-flex align-items-stretch">
      ...
      <div class="image col-lg-5"><img src="../assets/img/featured-pic-1.jpeg" alt="..."></div>
    </div>
    <!-- Post        -->
    <div class="row d-flex align-items-stretch">
      <div class="image col-lg-5"><img src="../assets/img/featured-pic-2.jpeg" alt="..."></div>
      <div class="text col-lg-7">
        <div class="text-inner d-flex align-items-center">
          <div class="content">
            <header class="post-header">
    ...
    <div class="row d-flex align-items-stretch">
      ...
      <div class="image col-lg-5"><img src="../assets/img/featured-pic-3.jpeg" alt="..."></div>
    </div>
  </div>
</section>
<!-- Divider Section-->
<section style="background: url(../assets/img/divider-bg.jpg); background-size: cover; background-position: center bottom" class="divider">
  <div class="container">
    <div class="row">
      <div class="col-md-7">
...
<section class="gallery no-padding">
  <div class="row">
    <div class="mix col-lg-3 col-md-3 col-sm-6">
      <div class="item"><a href="../assets/img/gallery-1.jpg" data-fancybox="gallery" class="image"><img src="../assets/img/gallery-1.jpg" alt="..." class="img-fluid">
          <div class="overlay d-flex align-items-center justify-content-center"><i class="icon-search"></i></div>
        </a></div>
    </div>
    <div class="mix col-lg-3 col-md-3 col-sm-6">
      <div class="item"><a href="../assets/img/gallery-2.jpg" data-fancybox="gallery" class="image"><img src="../assets/img/gallery-2.jpg" alt="..." class="img-fluid">
          <div class="overlay d-flex align-items-center justify-content-center"><i class="icon-search"></i></div>
        </a></div>
    </div>
    <div class="mix col-lg-3 col-md-3 col-sm-6">
      <div class="item"><a href="../assets/img/gallery-3.jpg" data-fancybox="gallery" class="image"><img src="../assets/img/gallery-3.jpg" alt="..." class="img-fluid">
          <div class="overlay d-flex align-items-center justify-content-center"><i class="icon-search"></i></div>
        </a></div>
    </div>
    <div class="mix col-lg-3 col-md-3 col-sm-6">
      <div class="item"><a href="../assets/img/gallery-4.jpg" data-fancybox="gallery" class="image"><img src="../assets/img/gallery-4.jpg" alt="..." class="img-fluid">
          <div class="overlay d-flex align-items-center justify-content-center"><i class="icon-search"></i></div>
        </a></div>
    </div>
  </div>
